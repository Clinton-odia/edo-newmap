                ...
                <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                    <div class="footer-widget links-widget">
                        ...
                        <div class="widget-content">
                            <p>Edo NEWMAP-EIB is the European Investment Bank-Assisted Nigeria Climate Adaptation -
                                Erosion and Watershed Project aimed at reducing land degradation</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                    ...
                    <div class="footer-widget contact-widget">
                        ...
                        <div class="widget-content">
                            <ul class="info clearfix">
                                <li>
                                    <!--<h5>Location</h5>-->
                                    <p>5th Floor, Block D, Secretariat Complex, Sapele Road,Benin City, Edo State,
                                        Nigeria.</p>
                                </li>
                                <li>
                                    <h5>Phone</h5>
        ...
        <div class="auto-container">
            <div class="bottom-inner clearfix">
                <div class="copyright pull-left text-white">
                    <p class="text-white">&copy; 2026<!-- <a href="index.html">Whitehall City Govt.</a>--> All Rights
                        Reserved. EDO NEWMAP-EIB</p>
                </div>
...
<a href="https://wa.me/2348173150000?text=Hello%20EDO%20NEWMAP-EIB%20Team" target="_blank" class="whatsapp-float-btn"
    title="Chat with EDO NEWMAP-EIB Support">
